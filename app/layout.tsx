...
export const metadata: Metadata = {
  ...
  description: "Layanan laundry profesional dengan teknologi modern. Cuci kering, setrika, express 3 jam, dan antar-jemput gratis. Deterjen premium dan garansi kebersihan 100%. Melayani Jakarta dan sekitarnya.",
  keywords: ["laundry", "cuci pakaian", "setrika", "antar jemput", "laundry express", "layanan laundry", "dry cleaning", "laundry kiloan", "cuci karpet", "cuci selimut", "laundry 24 jam", "laundry terdekat", "laundry Jakarta"],
      ...
      <head>
        ...
        <script
          dangerouslySetInnerHTML={{
            __html: `
              (function() {
                // Remove extension attributes immediately before React loads
                var attrs = ['fdprocessedid', 'data-lastpass-icon-root', 'data-lastpass-root', 'data-form-type', 'data-kwimpalastatus', 'data-kwimpalaid', 'data-1p-ignore', 'data-dashlane-rid', 'data-bwignore'];
                ...
                // Stop cleaning after 3 seconds (React should be loaded by then)
                setTimeout(function() {
